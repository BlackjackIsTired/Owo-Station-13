...
/datum/species
	...
	var/icobase = 'icons/mob/human_races/r_vox.dmi'    // Normal icon set.
	var/deform = 'icons/mob/human_races/r_def_vox.dmi' // Mutated icon set.
	...
	var/icon = 'icons/mob/human_races/r_vox.dmi'
	var/flags
	var/sprite_sheets
